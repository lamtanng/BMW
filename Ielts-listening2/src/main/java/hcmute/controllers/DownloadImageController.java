...
public class DownloadImageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (isValidFileName(fileName)) {
        	...
        	// Sau khi xây dựng đường dẫn tuyệt đối đến tệp, mã kiểm tra xem đường dẫn này có bắt đầu bằng thư mục gốc DIR hay không. Nếu không, đường dẫn tệp sẽ không nằm trong phạm vi của DIR và được coi là không hợp lệ.
